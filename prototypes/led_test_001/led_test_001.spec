...
# optional items
#Vendor: Stephen M Moraco
#Distribution:
#Icon:
#URL:
#Packager: Stephen M Moraco stephen@ironsheep.biz
...
Summary: testbed for GPIO and WS2812B String

%description
testbed for GPIO and WS2812B String
led_test_001.spec.  Generated from led_test_001.spec.in by configure.
Please edit led_test_001.spec.in to add several more lines of description
